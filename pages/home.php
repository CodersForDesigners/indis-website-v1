	...
	<div class="carousel-list js_carousel_content">
		...
		<?php foreach ( $featuredSpotlights as $index => $spotlight ) : ?>
			<div class="carousel-list-item js_carousel_item">
				...
				<a href="<?= $spotlight[ 'permalink' ] ?>?scrollto=spotlight" target="_blank" class="button fill-neutral-4 text-light button-icon" style="--bg-i: url('../media/icon/icon-right-triangle-light.svg<?php echo $ver ?>'); --bg-c: var(--neutral-2);">Visit Project</a>
			</div>
		<?php endforeach; ?>
	</div>
