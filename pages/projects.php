...
$showEngineeringWaterVariant2 = getContent( [ ], 'engineering_section_water_variant_2' );
	...
	<div class="container">
		<div class="row">
			...
			<div class="project-card columns small-8 medium-4 fill-dark space-25">
				...
				<div class="price h5 condensed text-neutral-3"><?= getContent( '', 'price' ) ?></div>
			</div>
...
<!-- Engineering Section : Water variant 2 (used for the MYRA Villas project) -->
<?php if ( ! empty( $showEngineeringWaterVariant2 ) ) : ?>
<section data-section="Engineering — Water" data-id="engineering-water" id="engineering-water" class="engineering-section water">
	<div class="container">
		<div class="row row-1">
			<div class="section-label columns small-12 xlarge-10 xlarge-offset-1 space-25-bottom">
			...
			<div class="heading columns small-12 medium-6 large-5 xlarge-4 xlarge-offset-1 space-50-bottom">
				<div class="h3 strong text-lowercase space-25-bottom">The engineering that ensures <span class="text-red-2">your water comes to you at the right pressure without overhead tanks.</span></div>
			</div>
			<div class="points columns small-12 medium-5 large-3 large-offset-1">
				<div class="title h4 strong space-25-bottom"><span class="text-red-2">Water</span> <br>Engineering</div>
				<div class="point h5 condensed text-neutral-3 space-min-bottom">
				...
				<div class="point h5 condensed text-neutral-3 space-min-bottom">
					Pneumatic Booster Pumps actively boost water pressure without the need of overhead tanks.
				</div>
				<div class="point h5 condensed text-neutral-3 space-min-bottom">
					By removing overhead water tanks the look and feel of a lifestyle Villa projects is vastly improved.
				</div>
			</div>
		</div>
	</div>
...
<?php endif; ?>
<!-- END: Engineering Section : Water 2 -->
	...
	<div class="container">
		<div class="row">
			...
			<div class="info columns small-12 medium-8 large-7 xlarge-6">
				...
				<div class="description p text-neutral-3 space-25-bottom">Built on the ethos of community living, you will always find more people sharing your interests and making life more meaningful. Sport plays an important role in character building. Kids need to explore and spread their wings to become well-rounded individuals, and adults need to stretch a little to uncover a healthier version of themselves.</div>
	...
	<div class="container">
		<div class="row">
			<div class="intro columns small-6 medium-3 large-2">
				...
				<div class="description h5 condensed text-neutral-3">
			...
			<div class="action-form columns small-10 medium-8 medium-offset-1 large-6 large-offset-0">
				<form class="js_book_site_visit_form" data-c="book-site-visit/<?= $urlSlug ?>">
					<div class="row">
						<div class="form-row columns small-12 medium-6">
							<label>
								<span class="label strong text-uppercase text-neutral-3 cursor-pointer">
									Name
								</span>
						...
						<div class="form-row columns small-12 medium-6">
							<label>
								<span class="invisible label strong text-uppercase text-neutral-3 cursor-pointer">
									Submit
								</span>
								<button class="button block fill-red-2 button-icon" type="submit" style="--bg-i: url('../media/icon/icon-right-triangle-light.svg<?php echo $ver ?>'); --bg-c: var(--red-1);">Submit</button>
							</label>
				...
				<form class="js_otp_form" style="display: none;">
					<div class="otp-trap row">
						<div class="form-row columns small-12 medium-6">
							<label class="block text-left">
								<span class="label strong inline text-neutral-3 text-uppercase">Enter the OTP</span>
