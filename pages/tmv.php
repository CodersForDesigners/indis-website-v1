		...
		<div class="row">
			<div class="columns small-12 medium-10 large-8">
				...
				<div class="h5 text-neutral-2 space-50-bottom">
					Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi veniam, repudiandae aut incidunt voluptatum quidem, nesciunt facilis labore temporibus molestias quaerat dicta magni illo obcaecati praesentium. Impedit, voluptas. Laborum, ad.
				</div>
			</div>
		</div>
		<div class="row">
			...
			<div class="columns small-12 medium-10 large-6">
				...
				<div class="row" style="border-top: solid 1px var(--neutral-2);">
					<div class="columns small-10 large-11 inline-middle">
						<a class="name h6 condensed" href="https://google.com">VivaCity-Masterplan</a>
					</div>
					<div class="columns small-2 large-1 inline-middle">
						<button class="icon-button inline" tabindex="-1" style="background-image: url('../media/icon/icon-clipboard-dark.svg<?php echo $ver ?>');"></button>
					</div>
				</div>
				<!-- END: For Each Item -->
