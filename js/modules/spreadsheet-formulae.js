...
( function ( rootNamespace ) {
	...
	formulae.IFERROR = function ( value, valueIfError ) {
		if ( value instanceof Error )
			if ( valueIfError !== void 0 || valueIfError !== null )
				return valueIfError;
			else
				return "";
		else
	...
	formulae.SEARCH = function ( needle, haystack, startPosition ) {
	...
	formulae.REGEXMATCH = function ( text, regular_expression ) {
		// if ( arguments.length < 2 )
		// 	return errors.na;

		// if ( typeof text !== "string" || ! ( regular_expression instanceof RegExp ) )
		if ( typeof text !== "string" || typeof regular_expression !== "string" )
			return errors.na;
