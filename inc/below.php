			...
			<div class="row space-50-top space-25-bottom">
				<div class="container">
					<div class="footer-info columns small-12 medium-10 large-8">
						...
						<div class="description p text-neutral-2 space-25-bottom">INDIS has a long history. Its roots can be traced to an international partnership in 2006 with the formation of PBEL Property Development. This began as a partnership between INCOR, the Indian partner and two Israeli companies, PBC and Electra. The vision was to provide high quality gated community lifestyles to Indian families. PBEL City was the flagship project that kicked off this partnership. They launched PBEL City projects across Hyderabad and Chennai which are successes in their respective geographies. With the exit of both Israeli partners in 2016, INCOR became a wholly Indian-owned company. The central vision of providing Indian families with gated community lifestyles expanded to building an engineering capability and team. The high rise engineering experience gained in PBEL City helped standardise materials and establish safety and maintenance protocols. A strong ethos of partnership, assembling a team of reputed architects, engineering consultants, contractors and material suppliers laid the foundation for this engineering capability. INCOR is today INDIS. INDIS scaled to newer heights by adding more projects, ONE CITY, VIVA CITY and VB City.</div>
					</div>
			...
			<div class="row space-25-top-bottom">
				<div class="container">
					...
					<div class="footer-address columns small-12 large-4 xlarge-3 xlarge-offset-1">
						...
						<a href="https://goo.gl/maps/jFcbmAJ1rhwwh5Wo6" target="_blank" class="link label strong text-red-2 text-uppercase inline-middle">Open in Google Maps <img class="link-icon inline-middle" src="../media/icon/icon-location-color.svg<?php echo $ver ?>"></a>
					</div>
				</div>
			</div>
		</section>
